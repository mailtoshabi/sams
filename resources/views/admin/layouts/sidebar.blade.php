                ...
                @if ($user->hasRole(['Administrator', 'Manager']))
                    ...
                    <li class="{{ request()->routeIs('admin.classical_diseases.*') ? 'mm-active' : '' }}">
                        <a href="javascript:void(0);"
                            class="has-arrow {{ request()->routeIs('admin.classical_diseases.*') ? 'mm-active' : '' }}">
                            <i class="fas fa-viruses"></i> <span>Classical Diseases</span>
                        </a>
                        <ul class="sub-menu {{ request()->routeIs('admin.classical_diseases.*') ? 'mm-show' : '' }}">
                            <li><a href="{{ route('admin.classical_diseases.index') }}"
                                    class="{{ request()->routeIs('admin.classical_diseases.index') ? 'active' : '' }}"><i
                                        class="fas fa-list"></i> All Classical Diseases</a></li>
                            <li><a href="{{ route('admin.classical_diseases.create') }}"
                                    class="{{ request()->routeIs('admin.classical_diseases.create') ? 'active' : '' }}"><i
                                        class="fas fa-plus-circle"></i> Link Fields</a></li>
                        </ul>
                    </li>

                    {{-- Modern Diseases --}}
                    <li class="{{ request()->routeIs('admin.modern_diseases.*') ? 'mm-active' : '' }}">
                        <a href="javascript:void(0);"
                            class="has-arrow {{ request()->routeIs('admin.modern_diseases.*') ? 'mm-active' : '' }}">
                            <i class="fas fa-map-marker"></i> <span>Modern Diseases</span>
                        </a>
                        <ul class="sub-menu {{ request()->routeIs('admin.modern_diseases.*') ? 'mm-show' : '' }}">
                            <li><a href="{{ route('admin.modern_diseases.index') }}"
                                    class="{{ request()->routeIs('admin.modern_diseases.index') ? 'active' : '' }}"><i
                                        class="fas fa-list"></i> All Modern Diseases</a></li>
                            <li><a href="{{ route('admin.modern_diseases.create') }}"
                                    class="{{ request()->routeIs('admin.modern_diseases.create') ? 'active' : '' }}"><i
                                        class="fas fa-plus-circle"></i> Link Fields</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="{{ request()->routeIs('admin.proceedures.*') ? 'mm-active' : '' }}">
                        <a href="javascript:void(0);"
                            class="has-arrow {{ request()->routeIs('admin.proceedures.*') ? 'mm-active' : '' }}">
                            <i class="fas fa-leaf"></i> <span>Ayurvedic Procedures</span>
                        </a>
                        <ul class="sub-menu {{ request()->routeIs('admin.proceedures.*') ? 'mm-show' : '' }}">
                            <li><a href="{{ route('admin.proceedures.index') }}"
                                    class="{{ request()->routeIs('admin.proceedures.index') ? 'active' : '' }}"><i
                                        class="fas fa-list"></i> All Procedures</a></li>
                            <li><a href="{{ route('admin.proceedures.create') }}"
                                    class="{{ request()->routeIs('admin.proceedures.create') ? 'active' : '' }}"><i
                    ...
                    <li class="{{ request()->routeIs('admin.divisions.*') ? 'mm-active' : '' }}">
                        <a href="javascript:void(0);"
                            class="has-arrow {{ request()->routeIs('admin.divisions.*') ? 'mm-active' : '' }}">
                        ...
                        <ul class="sub-menu {{ request()->routeIs('admin.divisions.*') ? 'mm-show' : '' }}">
                            <li><a href="{{ route('admin.divisions.index') }}"
                                    class="{{ request()->routeIs('admin.divisions.index') ? 'active' : '' }}"><i
                                        class="fas fa-list"></i> All Divisions</a></li>
                            <li><a href="{{ route('admin.divisions.create') }}"
                                    class="{{ request()->routeIs('admin.divisions.create') ? 'active' : '' }}"><i
                    ...
                    <li class="{{ request()->routeIs('admin.chapters.*') ? 'mm-active' : '' }}">
                        <a href="javascript:void(0);"
                            class="has-arrow {{ request()->routeIs('admin.chapters.*') ? 'mm-active' : '' }}">
                        ...
                        <ul class="sub-menu {{ request()->routeIs('admin.chapters.*') ? 'mm-show' : '' }}">
                            <li><a href="{{ route('admin.chapters.index') }}"
                                    class="{{ request()->routeIs('admin.chapters.index') ? 'active' : '' }}"><i
                                        class="fas fa-list"></i> All Chapters</a></li>
                            <li><a href="{{ route('admin.chapters.create') }}"
                                    class="{{ request()->routeIs('admin.chapters.create') ? 'active' : '' }}"><i
                    ...
                    <li class="{{ request()->routeIs('admin.formulations.*') ? 'mm-active' : '' }}">
                        <a href="javascript:void(0);"
                            class="has-arrow {{ request()->routeIs('admin.formulations.*') ? 'mm-active' : '' }}">
                            <i class="fas fa-vial"></i> <span>Formulations</span>
                        </a>
                        <ul class="sub-menu {{ request()->routeIs('admin.formulations.*') ? 'mm-show' : '' }}">
                            <li><a href="{{ route('admin.formulations.index') }}"
                                    class="{{ request()->routeIs('admin.formulations.index') ? 'active' : '' }}"><i
                                        class="fas fa-list"></i> All Formulations</a></li>
                            <li><a href="{{ route('admin.formulations.create') }}"
                                    class="{{ request()->routeIs('admin.formulations.create') ? 'active' : '' }}"><i
                    ...
                    <li class="{{ request()->routeIs('admin.titles.*') ? 'mm-active' : '' }}">
                        <a href="javascript:void(0);"
                            class="has-arrow {{ request()->routeIs('admin.titles.*') ? 'mm-active' : '' }}">
                            <i class="fas fa-heading"></i> <span>Titles</span>
                        </a>
                        <ul class="sub-menu {{ request()->routeIs('admin.titles.*') ? 'mm-show' : '' }}">
                            <li><a href="{{ route('admin.titles.index') }}"
                                    class="{{ request()->routeIs('admin.titles.index') ? 'active' : '' }}"><i
                                        class="fas fa-list"></i> All Titles</a></li>
                            <li><a href="{{ route('admin.titles.create') }}"
                                    class="{{ request()->routeIs('admin.titles.create') ? 'active' : '' }}"><i
                    ...
                    <li class="{{ request()->routeIs('admin.pharmaceutical_forms.*') ? 'mm-active' : '' }}">
                        <a href="javascript:void(0);"
                            class="has-arrow {{ request()->routeIs('admin.pharmaceutical_forms.*') ? 'mm-active' : '' }}">
                        ...
                        <ul class="sub-menu {{ request()->routeIs('admin.pharmaceutical_forms.*') ? 'mm-show' : '' }}">
                            <li><a href="{{ route('admin.pharmaceutical_forms.index') }}"
                                    class="{{ request()->routeIs('admin.pharmaceutical_forms.index') ? 'active' : '' }}"><i
                                        class="fas fa-list"></i> All Forms</a></li>
                            <li><a href="{{ route('admin.pharmaceutical_forms.create') }}"
                                    class="{{ request()->routeIs('admin.pharmaceutical_forms.create') ? 'active' : '' }}"><i
                    ...
                    <li class="{{ request()->routeIs('admin.manufacturing_companies.*') ? 'mm-active' : '' }}">
                        <a href="javascript:void(0);"
                            class="has-arrow {{ request()->routeIs('admin.manufacturing_companies.*') ? 'mm-active' : '' }}">
                        ...
                        <ul class="sub-menu {{ request()->routeIs('admin.manufacturing_companies.*') ? 'mm-show' : '' }}">
                            <li><a href="{{ route('admin.manufacturing_companies.index') }}"
                                    class="{{ request()->routeIs('admin.manufacturing_companies.index') ? 'active' : '' }}"><i
                                        class="fas fa-list"></i> All Companies</a></li>
                            <li><a href="{{ route('admin.manufacturing_companies.create') }}"
                                    class="{{ request()->routeIs('admin.manufacturing_companies.create') ? 'active' : '' }}"><i
                    ...
                    <li class="{{ request()->routeIs('admin.medicine_types.*') ? 'mm-active' : '' }}">
                        <a href="javascript:void(0);"
                            class="has-arrow {{ request()->routeIs('admin.medicine_types.*') ? 'mm-active' : '' }}">
                            <i class="fas fa-capsules"></i> <span>Medicine Type</span>
                        </a>
                        <ul class="sub-menu {{ request()->routeIs('admin.medicine_types.*') ? 'mm-show' : '' }}">
                            <li><a href="{{ route('admin.medicine_types.index') }}"
                                    class="{{ request()->routeIs('admin.medicine_types.index') ? 'active' : '' }}"><i
                                        class="fas fa-list"></i> All Medicine Type</a></li>
                            <li><a href="{{ route('admin.medicine_types.create') }}"
                                    class="{{ request()->routeIs('admin.medicine_types.create') ? 'active' : '' }}"><i
                                        class="fas fa-plus-circle"></i> Add Medicine Type</a></li>
                        </ul>
                    </li>
                    <li class="{{ request()->routeIs('admin.medicines.*') ? 'mm-active' : '' }}">
                        <a href="javascript:void(0);"
                            class="has-arrow {{ request()->routeIs('admin.medicines.*') ? 'mm-active' : '' }}">
                            <i class="fas fa-pills"></i> <span>Medicines</span>
                        </a>
                        <ul class="sub-menu {{ request()->routeIs('admin.medicines.*') ? 'mm-show' : '' }}">
                            <li><a href="{{ route('admin.medicines.index') }}"
                                    class="{{ request()->routeIs('admin.medicines.index') ? 'active' : '' }}"><i
                                        class="fas fa-list"></i> All Medicines</a></li>
                            <li><a href="{{ route('admin.medicines.create') }}"
                                    class="{{ request()->routeIs('admin.medicines.create') ? 'active' : '' }}"><i
                    ...
                    <li class="{{ request()->routeIs('admin.diseases.*') ? 'mm-active' : '' }}">
                        <a href="javascript:void(0);"
                            class="has-arrow {{ request()->routeIs('admin.diseases.*') ? 'mm-active' : '' }}">
                            <i class="fas fa-virus"></i> <span>Diseases</span>
                        </a>
                        <ul class="sub-menu {{ request()->routeIs('admin.diseases.*') ? 'mm-show' : '' }}">
                            <li><a href="{{ route('admin.diseases.index') }}"
                                    class="{{ request()->routeIs('admin.diseases.index') ? 'active' : '' }}"><i
                                        class="fas fa-list"></i> All Diseases</a></li>
                            <li><a href="{{ route('admin.diseases.create') }}"
                                    class="{{ request()->routeIs('admin.diseases.create') ? 'active' : '' }}"><i
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li><a href="{{ route('admin.commercial_oushadha_kalpanas.index') }}"><i
                                        class="fas fa-vials"></i> COMMERCIAL OUSHADHA KALPANAS</a></li>
                            <li><a href="{{ route('admin.new_pharmaceutical_forms.index') }}"><i class="fas fa-flask"></i>
                                    NEW PHARMACEUTICAL FORMS</a></li>
                            <li><a href="#"><i class="fas fa-project-diagram"></i> DOSHA GUNA BASED CLASSIFICATION</a></li>
                            <li><a href="{{ route('admin.therapeutic_differences.index') }}"><i
                            ...
                            <li><a href="{{ route('admin.raw_drug_indices.index') }}"><i class="fas fa-seedling"></i> RAW
                                    DRUG INDEX</a></li>
                            <li><a href="#"><i class="fas fa-yin-yang"></i> SIDDHA MEDICINES</a></li>
                            <li><a href="{{ route('admin.authors.index') }}"><i class="fas fa-user-edit"></i> AUTHORS</a>
                            </li>
                            <li><a href="{{ route('admin.articles.index') }}"><i class="fas fa-newspaper"></i> ARTICLES</a>
                            </li>
                        </ul>
                    </li>
                @endif
