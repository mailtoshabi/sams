...
@section('title') {{ __('Edit Link Division & Disease') }} @endsection
@section('css')
...
@section('content')
    ...
    @slot('li_2') Edit Link @endslot
    @slot('title') {{ 'Edit Link Division & Disease' }} @endslot
    @endcomponent
    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('admin.modern_diseases.update', $modernDisease->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="division_id" class="form-select select2-ajax"
                                ...
                                @foreach($divisions as $division)
                                    <option value="{{ $division->id }}" {{ old('division_id', $modernDisease->division_id) == $division->id ? 'selected' : '' }}>
                                        {{ $division->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="disease_id" class="form-select select2-ajax"
                                ...
                                @foreach($diseases as $disease)
                                    <option value="{{ $disease->id }}" {{ old('disease_id', $modernDisease->disease_id) == $disease->id ? 'selected' : '' }}>
                                        {{ $disease->name }}
                                    </option>
                                @endforeach
                            </select>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div id="medicines-container" class="row g-3">
                                            @if(count($selectedMedicines) > 0)
                                                @foreach($selectedMedicines as $med)
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div id="procedures-container" class="row g-3">
                                            @if(count($selectedProceedures) > 0)
                                                @foreach($selectedProceedures as $proc)
                                                            ...
                                                            <div class="card-body py-2 px-3 d-flex justify-content-between align-items-center">
                                                                <div class="d-flex align-items-center flex-grow-1">
                                                                    ...
                                                                    <div class="flex-grow-1 me-3">
                                                                        ...
                                                                        <small class="text-muted d-block">{{ $proc->pivot_description ?? 'No description' }}</small>
                                                                        <input type="hidden" name="proceedures[{{ $proc->id }}][description]" value="{{ $proc->pivot_description }}">
                                                                    </div>
                                                                </div>
