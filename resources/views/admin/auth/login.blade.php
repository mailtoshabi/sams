                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 text-center">
                                <a href="{{ url('/') }}" class="d-block auth-logo">
                                    <img src="{{ asset('images/logo.png') }}" alt="@appName" height="200">
                            ...
                            <div class="auth-content my-auto">
                                ...
                                <form class="mt-4 pt-2" action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="form-floating form-floating-custom mb-4">
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', 'shafeer@gmail.com') }}" id="input-username" placeholder="Enter User Name" name="email">
                                        @error('email')
