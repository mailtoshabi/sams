                    ...
                    @if (empty($customer->kitchen))
                        ...
                        <div class="col-sm-12 d-none mb-3 position-relative" id="kitchenContainer">
                            ...
                            <select id="kitchen_id" name="kitchen_id" class="form-control">
                                <option value="{{ isset($customer)&&(!empty($customer->kitchen))? encrypt($customer->kitchen->id) : '' }}" selected>{{ isset($customer)&&(!empty($customer->kitchen))? $customer->kitchen->name : '' }}</option>
                            </select>
