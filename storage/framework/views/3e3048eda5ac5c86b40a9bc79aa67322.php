                ...
                <div id="dynamic-fields" class="col-12">
                    <div class="row g-3">
                        ...
                        <?php
                            ...
                            if (old('medicines')) {
                                $selectedMedicines = \App\Models\Medicine::whereIn('id', old('medicines'))->get();
                            } else {
                                $selectedMedicines = $modernDisease->medicines;
                            }
                        ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div id="medicines-container" class="row g-3">
                                            <?php if(count($selectedMedicines) > 0): ?>
                                                <?php $__currentLoopData = $selectedMedicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $med): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <!-- Procedures Section -->
                        <?php
                            $selectedProceedures = collect([]);
                            if (old('proceedures')) {
                                $selectedIds = array_keys(old('proceedures'));
                                $selectedProceedures = \App\Models\Proceedure::whereIn('id', $selectedIds)->get()->map(function($proc) {
                                    $proc->pivot_description = old('proceedures.' . $proc->id . '.description');
                                    return $proc;
                                });
                            } else {
                                $selectedProceedures = $modernDisease->proceedures->map(function($proc) {
                                    $proc->pivot_description = $proc->pivot->description;
                                    return $proc;
                                });
                            }
                        ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div id="procedures-container" class="row g-3">
                                            <?php if(count($selectedProceedures) > 0): ?>
                                                <?php $__currentLoopData = $selectedProceedures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div class="card-body py-2 px-3 d-flex justify-content-between align-items-center">
                                                                <div class="d-flex align-items-center flex-grow-1">
                                                                    ...
                                                                    <div class="flex-grow-1 me-3">
                                                                        ...
                                                                        <small class="text-muted d-block"><?php echo e($proc->pivot_description ?? 'No description'); ?></small>
                                                                        <input type="hidden" name="proceedures[<?php echo e($proc->id); ?>][description]" value="<?php echo e($proc->pivot_description); ?>">
                                                                    </div>
                                                                </div>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\sams\resources\views\admin\modern_diseases\edit.blade.php ENDPATH**/ ?>