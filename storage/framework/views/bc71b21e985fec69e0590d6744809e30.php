        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('assets/images/logo-sm.svg')); ?>" alt="" height="24"> <span class="logo-txt">SAMS</span>
                    </span>
                </a>
...
<?php /**PATH C:\xampp\htdocs\sams\resources\views/admin/layouts/topbar.blade.php ENDPATH**/ ?>