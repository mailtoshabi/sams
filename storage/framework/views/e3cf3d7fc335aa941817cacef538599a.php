...
<div class="row g-3">
    ...
    <div class="col-md-6">
        ...
        <input type="text" name="name" class="form-control"
               value="<?php echo e(old('name', $proceedure->name ?? '')); ?>" required
    ...
    <div class="col-md-6">
        ...
        <input type="text" name="ayurveda_name" class="form-control"
            value="<?php echo e(old('ayurveda_name', $proceedure->ayurveda_name ?? '')); ?>"
    ...
    <div class="col-md-6">
        ...
        <select name="status" class="form-select">
            <option value="published" <?php echo e(old('status', $proceedure->status ?? '') === 'published' ? 'selected' : ''); ?>>Published</option>
            <option value="draft" <?php echo e(old('status', $proceedure->status ?? '') === 'draft' ? 'selected' : ''); ?>>Draft</option>
        </select>
    </div>
    ...
    <div class="col-md-6">
        ...
        <div class="mt-2" id="mainPreviewContainer">
            <?php if(!empty($proceedure->image_path)): ?>
                <img id="mainPreviewImage" src="<?php echo e(asset('storage/'.$proceedure->image_path)); ?>" width="120" class="rounded border">
            <?php else: ?>
    ...
    <div class="col-12">
        ...
        <textarea name="description" id="mainEditor" class="form-control" rows="5"><?php echo e(old('description', $proceedure->description ?? '')); ?></textarea>
    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\sams\resources\views\admin\proceedures\_form.blade.php ENDPATH**/ ?>