<?php $__env->startSection('title', 'My Zopa Profile ' . config('app.name')); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="city" name="city" type="text" class="form-control" placeholder="Location" value="<?php echo e(old('city', $customer->city)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if(empty($customer->kitchen)): ?>
                        <div class="col-sm-12 required">
                            <label for="postal_code">Location</label>

                            <!-- Input group for input + tooltip button -->
                            <div class="input-group mb-2">
                                <input type="text" id="autocomplete" placeholder="Enter location" class="form-control" value="<?php echo e(isset($customer)?$customer->location_name:old('location_name')); ?>">
                                <button
                                    type="button"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <!-- Hidden fields -->
                            <input type="hidden" name="latitude" id="latitude" value="<?php echo e(isset($customer)?$customer->latitude:old('latitude')); ?>">
                            <input type="hidden" name="longitude" id="longitude" value="<?php echo e(isset($customer)?$customer->longitude:old('longitude')); ?>">
                            <input type="hidden" name="location_name" id="location_name" value="<?php echo e(isset($customer)?$customer->location_name:old('location_name')); ?>">
                        ...
                        <div class="col-sm-12 d-none mb-3 position-relative" id="kitchenContainer">
                            ...
                            <select id="kitchen_id" name="kitchen_id" class="form-control">
                                <option value="<?php echo e(isset($customer)&&(!empty($customer->kitchen))? encrypt($customer->kitchen->id) : ''); ?>" selected><?php echo e(isset($customer)&&(!empty($customer->kitchen))? $customer->kitchen->name : ''); ?></option>
                            </select>
                ...
                <div class="card-body row g-3">
                    <div class="col-md-6">
                        ...
                        <select name="language" class="form-control">
                            <option value="en" <?php echo e($customer->language === 'en' ? 'selected' : ''); ?>>English</option>
                            <option value="ml" <?php echo e($customer->language === 'ml' ? 'selected' : ''); ?>>മലയാളം</option>
                        </select>
                    </div>
                </div>
            </div>
...
<?php if(empty($customer->kitchen)): ?>
    <script>
        function fetchNearbyKitchens(lat, lng) {
            $.ajax({
                url: '<?php echo e(route("get.nearby.kitchens")); ?>',
                method: 'GET',
            ...
            $('#updateProfileForm').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        window.location.href = '<?php echo e(route("customer.profile")); ?>';
                    },
                    error: function (xhr) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\pages\profile.blade.php ENDPATH**/ ?>