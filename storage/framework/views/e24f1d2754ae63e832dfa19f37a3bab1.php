...
<div class="container mt-4">
    ...
    <form method="GET" action="<?php echo e(route('admin.authors.index')); ?>" class="row g-2 mb-4">
        <div class="col-md-4">
        ...
        <div class="col-md-2">
            ...
            <a href="<?php echo e(route('admin.authors.index')); ?>" class="btn btn-outline-secondary">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo e(route('admin.authors.edit', $item->id)); ?>" class="btn btn-sm btn-warning" title="Edit"><i class="bi bi-pencil"></i></a>
                                <form action="<?php echo e(route('admin.authors.destroy', $item->id)); ?>" method="POST" class="d-inline">
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\admin\authors\index.blade.php ENDPATH**/ ?>