                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 text-center">
                                <a href="<?php echo e(url('/')); ?>" class="d-block auth-logo">
                                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="<?php echo config('app.name'); ?>" height="200">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', 'shafeer@gmail.com')); ?>" id="input-username" placeholder="Enter User Name" name="email">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Samhitha of Ayurvedic Medical Specialities<br> Crafted with <i class="mdi mdi-heart text-danger"></i> by <a target="_blank" href="https://webmahal.com">Web Mahal</a></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>