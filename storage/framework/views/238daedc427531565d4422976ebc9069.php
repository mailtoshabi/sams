<?php $__env->startSection('title', 'My Leaves - ' . config('app.name')); ?>
...
<div class="container my-2">
    ...
    <div class="text-center mb-4">
        <h2 class="position-relative d-inline-block px-4 py-2">
            <?php echo e(__('messages.page.my_leaves')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\pages\meal_leaves.blade.php ENDPATH**/ ?>