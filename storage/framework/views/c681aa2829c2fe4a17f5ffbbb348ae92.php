                    ...
                    <div class="tab-pane active" role="tabpanel">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 text-end">
                                <a href="<?php echo e(route('admin.remarks.create')); ?>" class="btn btn-primary btn-sm"><i class="mdi mdi-plus"></i> <?php echo app('translator')->get('translation.Add_Remark'); ?></a>
                            </div>
                        </div>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\admin\remarks\index.blade.php ENDPATH**/ ?>