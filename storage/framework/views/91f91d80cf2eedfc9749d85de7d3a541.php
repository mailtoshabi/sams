<?php $__env->startSection('title', 'Purchase - ' . $meal->name . ' - ' . config('app.name')); ?>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo e(route('meal.purchase.store', encrypt($meal->id))); ?>">
                        ...
                        <div class="text-end mb-3">
                            <h5><strong>Grand Total: ₹<span id="grand-total"><?php echo e(number_format($meal->price, 2)); ?></span></strong></h5>
                        </div>
...
<script>
    function updateGrandTotal() {
        let mealPrice = parseFloat(<?php echo e($meal->price); ?>);
        let addonTotal = 0;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\pages\meal_purchase.blade.php ENDPATH**/ ?>