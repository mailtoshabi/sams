...
<div class="container mt-5">
    ...
    <div class="row align-items-center mt-4">
        <div class="col-md-6 order-md-1 order-2">
            <p>At <strong><?php echo config('app.name'); ?></strong>, we believe that everyone deserves nutritious and delicious meals, just like home. Our journey began with a simple mission: to provide fresh, homemade food to office workers and busy individuals who crave healthy and flavorful meals without the hassle of cooking.</p>
            ...
            <p>As we grow, our goal is to expand our offerings beyond meal delivery, bringing you an even wider selection of fresh and wholesome food options. Thank you for choosing <?php echo config('app.name'); ?> – your trusted partner for home-cooked goodness!</p>
            <h3>Our Story</h3>
        <p>At <?php echo config('app.name'); ?>, we started with a simple mission: to bring fresh, home-cooked meals to busy professionals and families. Our journey began with a passion for food and a deep understanding of the need for convenient, healthy, and delicious meal options. Today, we take pride in delivering nutritious meals right to your doorstep, prepared with love and care.</p>
        </div>
    ...
    <section class="mt-4 mb-5">
        ...
        <p>Join us on this journey to better eating habits and healthier living. At <?php echo config('app.name'); ?>, we don’t just serve food; we serve love, one meal at a time.</p>
        <h4>Stay healthy. Eat fresh. Enjoy home-cooked goodness with <?php echo config('app.name'); ?>!</h4>
    </section>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\pages\about_us.blade.php ENDPATH**/ ?>