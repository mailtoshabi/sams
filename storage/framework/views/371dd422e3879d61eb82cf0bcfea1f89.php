<?php $__env->startSection('title'); ?> <?php echo e(__('Edit Link Classical Disease Fields')); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->slot('title'); ?> <?php echo e('Edit Link Classical Disease Fields'); ?> <?php $__env->endSlot(); ?>
    <?php echo $__env->renderComponent(); ?>

    <div class="container mt-4">
        <h3 class="mb-4">Edit Link Classical Disease Fields</h3>
        ...
        <form action="<?php echo e(route('admin.classical_diseases.update', $classicalDisease->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="division_id" id="division_id" class="form-select select2-ajax"
                                ...
                                <?php $__currentLoopData = $divisions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $division): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($division->id); ?>" <?php echo e(old('division_id', $classicalDisease->division_id) == $division->id ? 'selected' : ''); ?>>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="chapter_id" id="chapter_id" class="form-select select2-ajax"
                                ...
                                <?php $__currentLoopData = $chapters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chapter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($chapter->id); ?>" <?php echo e(old('chapter_id', $classicalDisease->chapter_id) == $chapter->id ? 'selected' : ''); ?>>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="medicine_type_id" id="medicine_type_id" class="form-select select2-ajax"
                                ...
                                <?php $__currentLoopData = $medicine_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($mt->id); ?>" <?php echo e(old('medicine_type_id', $classicalDisease->medicine_type_id) == $mt->id ? 'selected' : ''); ?>>
                                        <?php echo e($mt->name); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="formulation_id" id="formulation_id" class="form-select select2-ajax"
                                ...
                                <?php $__currentLoopData = $formulations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $formulation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($formulation->id); ?>" <?php echo e(old('formulation_id', $classicalDisease->formulation_id) == $formulation->id ? 'selected' : ''); ?>>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="medicine_id" id="medicine_id" class="form-select select2-ajax"
                                ...
                                <?php $__currentLoopData = $medicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($medicine->id); ?>" <?php echo e(old('medicine_id', $classicalDisease->medicine_id) == $medicine->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views/admin/classical_diseases/edit.blade.php ENDPATH**/ ?>