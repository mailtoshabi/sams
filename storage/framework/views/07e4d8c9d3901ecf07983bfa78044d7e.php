...
<div class="container mt-4">
    ...
    <form method="GET" action="<?php echo e(route('admin.medicines.index')); ?>" class="row g-2 mb-4">
        ...
        <div class="col-md-3">
            ...
            <a href="<?php echo e(route('admin.medicines.index')); ?>" class="btn btn-outline-secondary">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $medicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td><?php echo e($medicine->formulation?->name ?? 'No formulation assigned'); ?></td>
                        <td>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\sams\resources\views/admin/medicines/index.blade.php ENDPATH**/ ?>