    ...
    <div class="card shadow overflow-auto" style="width: 100%; max-width: 400px;">
        <div class="card-body">
            <div class="text-center mb-4 logo_bg pb-4 pt-4">
                <a href="<?php echo e(route('index')); ?>"><img src="<?php echo e(asset('front/images/logo.png')); ?>" alt="<?php echo config('app.name'); ?>" style="height: 100px; max-width: 100%;"></a>
            </div>
            ...
            <form id="registerForm" action="<?php echo e(route('front.register.submit')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3 position-relative" id="daily_quantity_group" style="display:none;">
                    <input type="number" min="1" class="form-control pe-5" name="daily_quantity" id="daily_quantity" placeholder="Min. Daily Meal Quantity" value="<?php echo e(old('daily_quantity')); ?>">
                    <i class="fa fa-envelope input-icon"></i>
                </div>
...
<?php echo $__env->make('layouts.out', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\pages\register_copy 2.blade.php ENDPATH**/ ?>