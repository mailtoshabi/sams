            ...
            <div class="row g-4 align-items-start">
                ...
                <div class="col-md-9">
                    <table class="table table-borderless mb-0">
                        ...
                        <?php if(!empty($medicine->ayurveda_name)): ?>
                        <tr>
                            <th>Ayurveda Name</th>
                            <td><?php echo e($medicine->ayurveda_name); ?></td>
                        </tr>
                        <?php endif; ?>
                        <tr>
                            <th>Medicine Type</th>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\sams\resources\views\admin\medicines\show.blade.php ENDPATH**/ ?>