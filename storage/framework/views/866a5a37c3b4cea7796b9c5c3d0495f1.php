    ...
    <div class="col-md-6">
        ...
        <select name="formulation_id" class="form-select">
            ...
            <?php $__currentLoopData = $formulations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $formulation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($formulation->id); ?>" <?php if(old('formulation_id', $medicine->formulation_id ?? null) == $formulation->id): echo 'selected'; endif; ?>>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\xampp\htdocs\sams\resources\views/admin/medicines/_form.blade.php ENDPATH**/ ?>