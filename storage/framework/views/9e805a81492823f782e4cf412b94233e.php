    ...
    <div class="card shadow" style="width: 100%; max-width: 400px;">
        <div class="card-body">
            ...
            <form id="loginForm" action="<?php echo e(route('customer.login.submit')); ?>" method="POST">
                ...
                <div class="mb-1 text-end"><small><a href="<?php echo e(route('customer.front.login.otp')); ?>" class="text-decoration-none"><small>Forgot password?</small></a></small></div>
...
<?php echo $__env->make('layouts.out', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\pages\login.blade.php ENDPATH**/ ?>