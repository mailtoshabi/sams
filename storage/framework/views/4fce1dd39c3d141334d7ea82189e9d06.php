<div class="col-md-12 p-4 lh-lg">
        ...
        <p><small><i>Note: Add-on purchases cannot be canceled after <?php echo e($lastOrderTime); ?> on the day of delivery.</i></small></p>
        ...
        <ul>
            <li>You can apply leave up to <strong><?php echo e(Utility::MAX_LEAVE_DAYS_AHEAD); ?></strong> days in advance.</li>
            <li>You <strong>cannot mark leave for past dates</strong>.</li>
            <li>Today's leave must be applied <strong>before <?php echo e($lastOrderTime); ?></strong>.</li>
        ...
        <ul>
            ...
            <li><strong>Missed the cutoff time?</strong> Orders, leaves, and add-on changes can't be made after <strong><?php echo e($lastOrderTime); ?></strong>.</li>
        </ul>
        ...
        <ul>
            ...
            <li>Don't forget to apply leaves before <strong><?php echo e($lastOrderTime); ?></strong>.</li>
        </ul>
...
<?php /**PATH C:\xampp\htdocs\sams\resources\views\partials\how_to_use_content.blade.php ENDPATH**/ ?>