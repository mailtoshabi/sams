<?php $__env->startSection('title', 'Signup - ' . config('app.name')); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3 d-none position-relative" id="kitchenContainer">
                    ...
                    <small id="kitchenMessage" class="text-danger d-none">No nearby kitchen found. Contact our <a href="<?php echo e(route('support')); ?>">Support</a></small>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('form#registerForm').on('submit', function(event) {
            ...
            if (customerType === '<?php echo e(Utility::CUSTOMER_TYPE_INST); ?>') {
    ...
    $(document).ready(function() {
        document.getElementById('customer_type').addEventListener('change', function () {
            document.getElementById('daily_quantity_group').style.display =
                this.value === '<?php echo e(Utility::CUSTOMER_TYPE_INST); ?>' ? 'block' : 'none';
...
<?php echo $__env->make('layouts.out', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\pages\register.blade.php ENDPATH**/ ?>