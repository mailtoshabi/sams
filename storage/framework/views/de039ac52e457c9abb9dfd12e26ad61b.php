<?php $__env->startSection('title', 'Login via OTP - ' . config('app.name')); ?>
        ...
        <div class="card-body">
            <div class="text-center mb-4 logo_bg pb-4 pt-4">
                <a href="<?php echo e(route('index')); ?>">
                    <img src="<?php echo e(asset('front/images/logo.png')); ?>" alt="<?php echo config('app.name'); ?>" style="height: 100px;">
                </a>
            </div>
            ...
            <div class="text-center mt-3">
                <small><a href="<?php echo e(route('customer.login')); ?>">Login with password</a></small><br>
...
<?php echo $__env->make('layouts.out', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\pages\login_otp_.blade.php ENDPATH**/ ?>