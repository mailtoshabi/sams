...
<div style="font-family: sans-serif; color: #333;">
    ...
    The cutoff time is <strong><?php echo e($lastOrderTime); ?></strong>. You must request meals, leaves, or changes <strong>before <?php echo e($lastOrderTime); ?> on the same day</strong>.</p>

    <h3 style="color: #e60000;">How to Use <?php echo config('app.name'); ?></h3>
    <ol>
        ...
        <li><strong>Request Extra Meals</strong><br>
            Request extra meals (for guests or special needs) <strong>before <?php echo e($lastOrderTime); ?></strong> on the same day via the My Meals page.
        </li>
        ...
        <li><strong>Apply for Meal Leave</strong><br>
            ...
            - Cannot cancel after <strong><?php echo e($lastOrderTime); ?></strong> on the day.
        </li>
    ...
    <ul>
        ...
        <li>Always apply leaves or request extras <strong>before <?php echo e($lastOrderTime); ?></strong></li>
    </ul>

</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.pdf', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\pages\how_to_use_pdf.blade.php ENDPATH**/ ?>