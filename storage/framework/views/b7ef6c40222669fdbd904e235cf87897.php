<?php $__env->startSection('title', 'Buy A Meal - ' . config('app.name')); ?>
    ...
    <div class="row d-flex justify-content-center align-items-center">
            ...
            <div class="col-sm-6 mb-3">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div class="text-center mb-4">
                            <img src="<?php echo e(asset('front/images/meals.png')); ?>" alt="<?php echo config('app.name'); ?>" class="img-fluid d-block mx-auto">
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\pages\single_meal.blade.php ENDPATH**/ ?>