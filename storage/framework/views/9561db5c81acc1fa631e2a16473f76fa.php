...
<div class="container d-flex align-items-center justify-content-center py-4">
    <div class="card shadow overflow-auto" style="width: 100%; max-width: 400px;">
        <div class="card-body">
            ...
            <p class="text-center text-muted">Verifying phone number: <?php echo e($customer->phone); ?></p>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#send-otp-btn').on('click', function () {
            const phoneNumber = "+91<?php echo e($customer->phone); ?>";
...
<?php echo $__env->make('layouts.out', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\pages\verify_otp.blade.php ENDPATH**/ ?>