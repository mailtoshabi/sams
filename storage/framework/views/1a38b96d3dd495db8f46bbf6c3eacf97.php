<?php $__env->startSection('title', 'Site Map - ' . config('app.name')); ?>
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                    ...
                    <ul>
                        ...
                        <li><strong>Cutoff Time:</strong> Changes allowed only before <?php echo e($lastOrderTime); ?>.</li>
                    </ul>
                </li>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\pages\site_map.blade.php ENDPATH**/ ?>