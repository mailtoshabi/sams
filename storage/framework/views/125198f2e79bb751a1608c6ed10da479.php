<?php $__env->startSection('title', 'How to use - ' . config('app.name')); ?>

<?php $__env->startSection('content'); ?>
<div class="container my-4">
    <div class="text-center mb-4">
        <h2 class="position-relative d-inline-block px-4 py-2">
            <?php echo config('app.name'); ?> ഉപയോഗിക്കുന്ന വിധം
        </h2>
    ...
    <div class="row">
        <div class="col-md-12 p-4 lh-lg">
            ...
            <ul>
                <li>നിങ്ങൾക്ക് <strong><?php echo e(Utility::MAX_LEAVE_DAYS_AHEAD); ?></strong> ദിവസത്തോളം മുൻകൂട്ടി അവധി അപേക്ഷിക്കാം.</li>
                <li><strong><?php echo e($lastOrderTime); ?></strong> കഴിഞ്ഞാൽ ആ ദിവസം അവധി റദ്ദാക്കാനാകില്ല.</li>
            </ul>
            ...
            <ul>
                ...
                <li><strong>Cutoff സമയം കഴിഞ്ഞു?</strong> <strong><?php echo e($lastOrderTime); ?></strong> കഴിഞ്ഞാൽ ഓർഡർ അല്ലെങ്കിൽ Leave മാറ്റം സാധ്യമല്ല.</li>
            </ul>
            ...
            <ul>
                <li><a href="<?php echo e(route('site_map')); ?>">Site Map</a> ഉപയോഗിച്ച് എളുപ്പത്തിൽ നീങ്ങാം.</li>
                <li>നിങ്ങളുടെ Meal Wallet എപ്പോഴും മുഴുവനായിരിക്കാൻ ശ്രദ്ധിക്കുക.</li>
                <li>Leave-കൾ <strong><?php echo e($lastOrderTime); ?></strong> -ന് മുമ്പ് അപേക്ഷിക്കുക.</li>
            </ul>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\pages\how_to_use_ml.blade.php ENDPATH**/ ?>