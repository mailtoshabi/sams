...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link <?php if($is_active==Utility::ITEM_INACTIVE): ?> active <?php endif; ?>" <?php if($is_active==Utility::ITEM_INACTIVE): ?>aria-current="page"<?php endif; ?> href="<?php echo e(route('admin.orders.index','status='.encrypt(Utility::ITEM_INACTIVE))); ?>">Pending to add Wallet <span class="badge rounded-pill bg-soft-danger text-danger float-end"><?php echo e($count_new); ?></span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php if($is_active==Utility::ITEM_ACTIVE): ?> active <?php endif; ?>" <?php if($is_active==Utility::ITEM_ACTIVE): ?>aria-current="page"<?php endif; ?> href="<?php echo e(route('admin.orders.index','status='.encrypt(Utility::ITEM_ACTIVE))); ?>">Added to Wallet</a>
        </li>
        <li class="nav-item">
                                ...
                                <table class="table align-middle dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
                                    ...
                                    <?php $__currentLoopData = $customer_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer_order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-<?php echo e(($customer_order->pay_method == Utility::PAYMENT_ONLINE) ? 'primary' : 'secondary'); ?>">
                                                    <?php echo e($customer_order->is_paid ? 'online' : 'COD'); ?>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <?php if($customer_order->status == Utility::ITEM_INACTIVE): ?>
                                                                <li>
                                                                <a onclick="return confirm('Are you sure to Activate & Mark as Paid?')" class="dropdown-item" href="<?php echo e(route('admin.orders.activate', [encrypt($customer_order->id), 'paid'])); ?>">
                                                                    <i class="fas fa-credit-card font-size-16 text-success me-1"></i> Activate With Payment
                                                                </a>
                                                                </li>

                                                                <li>
                                                                <a onclick="return confirm('Are you sure to Activate without Payment?')" class="dropdown-item" href="<?php echo e(route('admin.orders.activate', [encrypt($customer_order->id), 'unpaid'])); ?>">
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\admin\customer_order\index.blade.php ENDPATH**/ ?>