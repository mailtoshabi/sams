                            ...
                            <div class="mb-3 required">
                                ...
                                <select id="kitchen_id" name="kitchen_id" class="form-control select2">
                                    ...
                                    <?php $__currentLoopData = $kitchens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kitchen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e(encrypt($kitchen->id)); ?>" <?php echo e(isset($customer)&&($customer->kitchen_id==$kitchen->id)?'selected':''); ?>><?php echo e($kitchen->display_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 required">
                                ...
                                <select id="customer_type" name="customer_type" class="form-control select2">
                                    ...
                                    <option value="<?php echo e(Utility::CUSTOMER_TYPE_IND); ?>" <?php echo e(isset($customer)&&($customer->customer_type==Utility::CUSTOMER_TYPE_IND)?'selected':''); ?>>Individual</option>
                                    <option value="<?php echo e(Utility::CUSTOMER_TYPE_INST); ?>" <?php echo e(isset($customer)&&($customer->customer_type==Utility::CUSTOMER_TYPE_INST)?'selected':''); ?>>Institution</option>
                                </select>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\admin\customers\create.blade.php ENDPATH**/ ?>