<?php $__env->startSection('title', 'സഹായം - ' . config('app.name')); ?>
...
<div class="container mt-5">
    ...
    <section class="mb-5">
        ...
        <p>ബന്ധപ്പെടുന്നതിനുമുമ്പ്, നിങ്ങളുടെ ചോദ്യങ്ങൾക്ക് ഉത്തരം ഞങ്ങളുടെ <a href="<?php echo e(route('faq')); ?>">FAQs വിഭാഗത്തിൽ</a> ലഭ്യമായിരിക്കാം.</p>
    </section>

    <section class="mb-5">
        <h3>ഓർഡർ & സബ്സ്ക്രിപ്ഷൻ പിന്തുണ</h3>
        <p>നിങ്ങളുടെ ഓർഡറുമായി അല്ലെങ്കിൽ സബ്സ്ക്രിപ്ഷനുമായി ബന്ധപ്പെട്ട സഹായം വേണ്ടെങ്കിൽ, നിങ്ങളുടെ <a href="<?php echo e(route('customer.profile')); ?>">പ്രൊഫൈൽ</a> പേജ് സന്ദർശിച്ച് ഭക്ഷണങ്ങൾ മാനേജ് ചെയ്യുക.</p>
    </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sams\resources\views\pages\support_ml.blade.php ENDPATH**/ ?>