...
<div class="row g-3">
    ...
    <div class="col-md-6">
        ...
        <input type="text" name="name" class="form-control"
               value="<?php echo e(old('name', $disease->name ?? '')); ?>" required
    ...
    <div class="col-md-3">
        ...
        <select name="status" class="form-select">
            ...
            <option value="draft" <?php echo e(old('status', $disease->status ?? '') === 'draft' ? 'selected' : ''); ?>>Draft</option>
        </select>
    </div>
    ...
    <div class="col-md-3">
        ...
        <div class="mt-2" id="mainPreviewContainer">
            <?php if(!empty($disease->image_path)): ?>
                <img id="mainPreviewImage" src="<?php echo e(asset('storage/'.$disease->image_path)); ?>" width="120" class="rounded border">
            <?php else: ?>
    ...
    <div class="col-12">
        ...
        <textarea name="description" id="mainEditor" class="form-control" rows="5"><?php echo e(old('description', $disease->description ?? '')); ?></textarea>
    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\sams\resources\views/admin/diseases/_form.blade.php ENDPATH**/ ?>