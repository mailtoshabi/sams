        ...
        <div class="card shadow">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <?php if($order->meals->isNotEmpty()): ?>
                        <p class="mb-0 ">
                            <?php $__currentLoopData = $order->meals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <i class="inr-size fa-solid fa-indian-rupee-sign"></i> <?php echo e(number_format($meal->price,2)); ?>
                    ...
                    <?php if($order->addons->isNotEmpty()): ?>
                        <p class="mb-0 ">
                            <?php $__currentLoopData = $order->addons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $addon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <i class="inr-size fa-solid fa-indian-rupee-sign"></i> <?php echo e(number_format($addon->price, 2)); ?>
                    ...
                    <h5>Grand Total: ₹<?php echo e(number_format($order->amount, 2)); ?></h5>
                    ...
                    <p>
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route('customer.orders.pay', encrypt($order->id))); ?>"
                        ...
                        <?php if($order->pay_method==Utility::PAYMENT_ONLINE): ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\sams\resources\views\partials\purchases_list.blade.php ENDPATH**/ ?>