...
use App\Http\Controllers\Admin\{
    ...
    MedicineController,
    DiseaseController,
    ProceedureController,
    DivisionController,
    ChapterController,
    FormulationController,
    DivisionChapterController,
    DivisionProceedureController,
    MedicineTypeController,
    CommercialOushadhaKalpanaController,
    PharmaceuticalFormController,
    ManufacturingCompanyController,
    NewPharmaceuticalFormController,
    TherapeuticDifferenceController,
    AuthorController,
    RawDrugIndexController,
    ArticleController,
    ModernDiseaseController,
    ClassicalDiseaseController
};
...
Route::prefix('super/admin')->middleware(['auth:web'])->group(function () {
    ...
    Route::resource('modern_diseases', ModernDiseaseController::class, ['as' => 'admin']);
    Route::resource('classical_diseases', ClassicalDiseaseController::class, ['as' => 'admin']);
